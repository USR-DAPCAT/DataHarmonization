...
load("DataHarmonization.Rdata")
#Taula0
kable(taula_events, digits = 2, caption="Tasa de Moratlidad por cada 10000 perosnas-año/Sexo") %>% kableExtra::kable_styling()
...
'Modelo lineal generalizado para ajustar un modelo de regresión de Poisson de la Tasas de  todo tipo de Mortalidad ,[Periodo*Grupo](figura00_TOTAL)'

figura00_TOTAL


'Modelo lineal generalizado para ajustar un modelo de regresión de Poisson de la Tasas de  todo tipo de Mortalidad ,[Periodo*Edad*Grupo](figura02_TOTAL2)'

figura02_TOTAL2

'Modelo lineal generalizado para ajustar un modelo de regresión de Poisson de la Tasas de  todo tipo de Mortalidad ,[Periodo+Edad+Grupo](figura02_TOTAL3)'
