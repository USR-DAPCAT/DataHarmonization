...
#Taula0
kable(taula_events2, digits = 2, caption="Tasa de Mortalidad por cada 1000 perosnas-año") %>% kableExtra::kable_styling()
#Taula1
kable(taula_events, digits = 2, caption="Tasa de Mortalidad por cada 1000 perosnas-año/Sexo") %>% kableExtra::kable_styling()
#Taula2
kable(taula_vida2, digits = 2, caption="Tabla de Mortalidad por año") %>% kableExtra::kable_styling()
