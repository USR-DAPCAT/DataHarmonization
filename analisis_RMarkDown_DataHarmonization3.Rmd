...
- Análisis de las tendencias en mortalidad cardiovascular a lo largo del tiempo entre el 01.01.2004 y la   captura más reciente del SIDIAP (31.12.2018) en personas con reciente diabetes tipo 2 y en comparación con 1 población control sin diabetes.

- Análisis de las diferncias y las proporciones de las tasas  en mortalidad  cardiovascular  a lo largo del tiempo  entre el 01.01.2004 y la   captura más reciente del SIDIAP (31.12.2018) en personas con reciente diabetes tipo 2 y en comparación con 1 población control sin diabetes.
...
load("DataHarmonization.Rdata")
#Taula0
kable(taula_events2, digits = 2, caption="Tasa de Moratlidad por cada 10000 perosnas-año") %>% kableExtra::kable_styling()
...
load("DataHarmonization.Rdata")
#Taula0
kable(taula_events, digits = 2, caption="Tasa de Moratlidad por cada 10000 perosnas-año/Sexe") %>% kableExtra::kable_styling()
...
'Modelo lineal generalizado para ajustar un modelo de regresión de Poisson de la Tasas de  todo tipo de Mortalidad ,para el Grupo Caso(Diabético Hombres).(figura3H)'

figura3H


'Modelo lineal generalizado para ajustar un modelo de regresión de Poisson de la Tasas de  todo tipo de Mortalidad ,para el Grupo Caso(Diabético Mujeres).(figura3D)'

figura3D


'Modelo lineal generalizado para ajustar un modelo de regresión de Poisson de la Tasas de  todo tipo de Mortalidad ,para e Grupo Control Hombres(figura4H)'

figura4H



'Modelo lineal generalizado para ajustar un modelo de regresión de Poisson de la Tasas de  todo tipo de Mortalidad ,para e Grupo Control Mujeres(figura4H)'
...
* Gráficas de Tasas de Mortalidad 2008, (Modelo Poisson)
